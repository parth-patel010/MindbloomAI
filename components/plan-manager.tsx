...
export default function PlanManager({ onBack }: PlanManagerProps) {
  const { currentPlan, credits, upgradeToProPlan, loading } = usePlan()
        ...
        <CardContent className="p-6 sm:p-8 space-y-6">
          ...
          <div className="space-y-4">
            {plans.map((plan, index) => {
              ...
              return (
                <div
                  key={plan.id}
                  className={`relative p-5 rounded-2xl border-2 transition-all duration-300 animate-in slide-in-from-left-4 duration-500 ${
                    plan.current
          ...
          <div className="p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border border-blue-200 animate-in slide-in-from-bottom-4 duration-500 delay-800">
            ...
            <div className="text-xs text-gray-500">
              Your payment is processed securely by Stripe. You can cancel anytime from your account.
            </div>
          </div>
